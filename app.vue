...
<template>
  ...
  <section>
    <label>
      <input type="checkbox" v-model="isAgreed">同意する
    </label>
    <p>同意の結果: {{ isAgreed }}</p>
  </section>
  <section>
  ...
  <section>
    ...
    <label><input type="checkbox" v-model="selectedOS" value="5">Andoroid</label>
